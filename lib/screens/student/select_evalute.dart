...
import 'package:exam_app/screens/teacher/conduct_paper.dart';
import 'package:exam_app/screens/teacher/evaluate_answer.dart';

class SelectEveluation extends StatefulWidget {
  final evaluate;

  const SelectEveluation({Key? key, required this.evaluate}) : super(key: key);

  @override
  _SelectEveluationState createState() => _SelectEveluationState();
}

class _SelectEveluationState extends State<SelectEveluation> {
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    if (session_id == '' || subjectId == '') {
                      ...
                      widget.evaluate
                          ? Get.off(() => EvaluateAnswer(),
                              arguments: [session_id, subjectId])
                          : Get.off(() => ConductPaper(),
                              arguments: [session_id, subjectId]);
                    }
                  },
                  child: Padding(
