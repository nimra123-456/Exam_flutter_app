...
StudentResult studentResultFromJson(String str) =>
    StudentResult.fromJson(json.decode(str));

class StudentResult {
  StudentResult({
    required this.totalResults,
    required this.passResults,
    required this.failResults,
  ...
  factory StudentResult.fromJson(Map<String, dynamic> json) => StudentResult(
        ...
        passResults: json["pass_results"],
        failResults: json["fail_results"],
        results:
